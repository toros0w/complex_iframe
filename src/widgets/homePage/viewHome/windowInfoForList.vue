      ...
      <template #tab-0>
        <div class="modelWindow__content">
          ...
          <div class="btns-wrapper">
            <div class="modelWindow__btns">
              ...
              <template v-if="apartment.status_type != 'not_for_sale' && apartment.status_type != 'sold'">
                  <MyButton class="request-btn" :theme="'green'" @click="handleApplicationClick(apartment.id)">
                      Создать заявку
                  </MyButton>
              </template>
            </div>
          ...
          <div class="square-price-and-btn">
            ...
            <div
                ref="pdfButton"
                class="action-button sendPDF to_send_complexes" 
                :class="{'active': apartment.inPdf}"
                :id="'send-complex-pdf-btn' + apartment.id"
                :data-in-pdf="apartment.inPdf"
...
const handleApplicationClick = (room_id) => {
