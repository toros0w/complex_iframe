    ...
    <div class="utp">
        <div v-if="isPreview" class="preview">
            <div
                ...
                class="text-sm"
            >
                <MyButton class="delete-btn" style="align-items: start" @click.prevent="$emit('delete-decoration', $event)" v-tooltip.top="'Удалить отделку'">
                ...
                <div v-tooltip.top="localDecoration.decoration_name" style="text-wrap: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 135px;">
                    {{ localDecoration.decoration_name }}
                </div>
            </div>
          <table>
            <tr>
              <td>
                <template v-if="localDecoration.photo">
                  <img
                      style="max-width: 220px;"
                      :src="typeof localDecoration.photo == 'string' ? localDecoration.photo : photoToObjectUrl(localDecoration.photo)"
                      alt=""
                  >
                </template>
              </td>
            ...
            <tr>
              <td>
                <template v-if="localDecoration.photo2">
                  <img
                      style="max-width: 220px;"
                      :src="typeof localDecoration.photo2 == 'string' ? localDecoration.photo2 : photoToObjectUrl(localDecoration.photo2)"
                      alt=""
                  >
                </template>
              </td>
            ...
            <tr>
              <td>
                <template v-if="localDecoration.photo3">
                  <img
                      style="max-width: 220px;"
                      :src="typeof localDecoration.photo3 == 'string' ? localDecoration.photo3 : photoToObjectUrl(localDecoration.photo3)"
                      alt=""
                  >
                </template>
              </td>
            ...
            <tr>
              <td>
                <template v-if="localDecoration.photo4">
                  <img
                      style="max-width: 220px;"
                      :src="typeof localDecoration.photo4 == 'string' ? localDecoration.photo4 : photoToObjectUrl(localDecoration.photo4)"
                      alt=""
                  >
                </template>
              </td>
            ...
            <tr>
              <td>
                <template v-if="localDecoration.photo5">
                  <img
                      style="max-width: 220px;"
                      :src="typeof localDecoration.photo5 == 'string' ? localDecoration.photo5 : photoToObjectUrl(localDecoration.photo5)"
                      alt=""
                  >
                </template>
              </td>
            ...
            <img
                v-tooltip.top="'Редактировать отделку'"
        ...
        <template v-else>
          <Dropdown @change="onChangeDecoration($event)" v-model="localDecoration.decoration_id" showClear :options="decorations" optionLabel="name" optionValue="code" class="w-full">
            ...
            <small
                v-if="errors.decoration_id"
                class="small_text p-invalid"
            >
                Выберите отделку
            </small>
            <Textarea
                v-model="localDecoration.desc"
          ...
          <div v-else class="house-photo-container">
            <img class="house-photo" :src="typeof localDecoration.photo == 'string' ? localDecoration.photo : photoToObjectUrl(localDecoration.photo)" alt="">
            <div @click.stop="localDecoration.photo = null" class="house-photo-overlay"><img
                src='@/shared/assets/images/complexes/trash.svg' alt="Удалить"></div>
          </div>
          <template v-if="!localDecoration.photo2">
            <input @change="onImagesAdded2" accept="image/*" type="file" class="hidden" ref="editInput2" />
            <MyButton @click.stop="handleAddImageClick2" :theme="'green'" class="text-sm">
              <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M7.0325 5.78251L8.75 4.05751V11.25C8.75 11.4489 8.82902 11.6397 8.96967 11.7803C9.11032 11.921 9.30109 12 9.5 12C9.69891 12 9.88968 11.921 10.0303 11.7803C10.171 11.6397 10.25 11.4489 10.25 11.25V4.05751L11.9675 5.78251C12.0372 5.85281 12.1202 5.90861 12.2116 5.94668C12.303 5.98476 12.401 6.00436 12.5 6.00436C12.599 6.00436 12.697 5.98476 12.7884 5.94668C12.8798 5.90861 12.9628 5.85281 13.0325 5.78251C13.1028 5.71279 13.1586 5.62984 13.1967 5.53845C13.2347 5.44705 13.2543 5.34902 13.2543 5.25001C13.2543 5.151 13.2347 5.05298 13.1967 4.96158C13.1586 4.87019 13.1028 4.78724 13.0325 4.71751L10.0325 1.71751C9.96117 1.64923 9.87706 1.59571 9.785 1.56001C9.6024 1.485 9.39759 1.485 9.215 1.56001C9.12294 1.59571 9.03883 1.64923 8.9675 1.71751L5.9675 4.71751C5.89757 4.78744 5.8421 4.87046 5.80425 4.96183C5.76641 5.05319 5.74693 5.15112 5.74693 5.25001C5.74693 5.34891 5.76641 5.44683 5.80425 5.5382C5.8421 5.62957 5.89757 5.71258 5.9675 5.78251C6.03743 5.85244 6.12045 5.90791 6.21181 5.94576C6.30318 5.9836 6.4011 6.00308 6.5 6.00308C6.59889 6.00308 6.69682 5.9836 6.78819 5.94576C6.87955 5.90791 6.96257 5.85244 7.0325 5.78251ZM16.25 9.00001C16.0511 9.00001 15.8603 9.07903 15.7197 9.21968C15.579 9.36034 15.5 9.5511 15.5 9.75001V14.25C15.5 14.4489 15.421 14.6397 15.2803 14.7803C15.1397 14.921 14.9489 15 14.75 15H4.25C4.05109 15 3.86032 14.921 3.71967 14.7803C3.57902 14.6397 3.5 14.4489 3.5 14.25V9.75001C3.5 9.5511 3.42098 9.36034 3.28033 9.21968C3.13968 9.07903 2.94891 9.00001 2.75 9.00001C2.55109 9.00001 2.36032 9.07903 2.21967 9.21968C2.07902 9.36034 2 9.5511 2 9.75001V14.25C2 14.8468 2.23705 15.419 2.65901 15.841C3.08097 16.263 3.65326 16.5 4.25 16.5H14.75C15.3467 16.5 15.919 16.263 16.341 15.841C16.7629 15.419 17 14.8468 17 14.25V9.75001C17 9.5511 16.921 9.36034 16.7803 9.21968C16.6397 9.07903 16.4489 9.00001 16.25 9.00001Z"
                    fill="white" />
          ...
          <div v-else class="house-photo-container">
            <img class="house-photo" :src="typeof localDecoration.photo2 == 'string' ? localDecoration.photo2 : photoToObjectUrl(localDecoration.photo2)" alt="">
            <div @click.stop="localDecoration.photo2 = null" class="house-photo-overlay"><img
                src='@/shared/assets/images/complexes/trash.svg' alt="Удалить"></div>
          </div>
          <template v-if="!localDecoration.photo3">
            <input @change="onImagesAdded3" accept="image/*" type="file" class="hidden" ref="editInput3" />
            <MyButton @click.stop="handleAddImageClick3" :theme="'green'" class="text-sm">
              <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M7.0325 5.78251L8.75 4.05751V11.25C8.75 11.4489 8.82902 11.6397 8.96967 11.7803C9.11032 11.921 9.30109 12 9.5 12C9.69891 12 9.88968 11.921 10.0303 11.7803C10.171 11.6397 10.25 11.4489 10.25 11.25V4.05751L11.9675 5.78251C12.0372 5.85281 12.1202 5.90861 12.2116 5.94668C12.303 5.98476 12.401 6.00436 12.5 6.00436C12.599 6.00436 12.697 5.98476 12.7884 5.94668C12.8798 5.90861 12.9628 5.85281 13.0325 5.78251C13.1028 5.71279 13.1586 5.62984 13.1967 5.53845C13.2347 5.44705 13.2543 5.34902 13.2543 5.25001C13.2543 5.151 13.2347 5.05298 13.1967 4.96158C13.1586 4.87019 13.1028 4.78724 13.0325 4.71751L10.0325 1.71751C9.96117 1.64923 9.87706 1.59571 9.785 1.56001C9.6024 1.485 9.39759 1.485 9.215 1.56001C9.12294 1.59571 9.03883 1.64923 8.9675 1.71751L5.9675 4.71751C5.89757 4.78744 5.8421 4.87046 5.80425 4.96183C5.76641 5.05319 5.74693 5.15112 5.74693 5.25001C5.74693 5.34891 5.76641 5.44683 5.80425 5.5382C5.8421 5.62957 5.89757 5.71258 5.9675 5.78251C6.03743 5.85244 6.12045 5.90791 6.21181 5.94576C6.30318 5.9836 6.4011 6.00308 6.5 6.00308C6.59889 6.00308 6.69682 5.9836 6.78819 5.94576C6.87955 5.90791 6.96257 5.85244 7.0325 5.78251ZM16.25 9.00001C16.0511 9.00001 15.8603 9.07903 15.7197 9.21968C15.579 9.36034 15.5 9.5511 15.5 9.75001V14.25C15.5 14.4489 15.421 14.6397 15.2803 14.7803C15.1397 14.921 14.9489 15 14.75 15H4.25C4.05109 15 3.86032 14.921 3.71967 14.7803C3.57902 14.6397 3.5 14.4489 3.5 14.25V9.75001C3.5 9.5511 3.42098 9.36034 3.28033 9.21968C3.13968 9.07903 2.94891 9.00001 2.75 9.00001C2.55109 9.00001 2.36032 9.07903 2.21967 9.21968C2.07902 9.36034 2 9.5511 2 9.75001V14.25C2 14.8468 2.23705 15.419 2.65901 15.841C3.08097 16.263 3.65326 16.5 4.25 16.5H14.75C15.3467 16.5 15.919 16.263 16.341 15.841C16.7629 15.419 17 14.8468 17 14.25V9.75001C17 9.5511 16.921 9.36034 16.7803 9.21968C16.6397 9.07903 16.4489 9.00001 16.25 9.00001Z"
                    fill="white" />
          ...
          <div v-else class="house-photo-container">
            <img class="house-photo" :src="typeof localDecoration.photo3 == 'string' ? localDecoration.photo3 : photoToObjectUrl(localDecoration.photo3)" alt="">
            <div @click.stop="localDecoration.photo3 = null" class="house-photo-overlay"><img
                src='@/shared/assets/images/complexes/trash.svg' alt="Удалить"></div>
          </div>
          <template v-if="!localDecoration.photo4">
            <input @change="onImagesAdded4" accept="image/*" type="file" class="hidden" ref="editInput4" />
            <MyButton @click.stop="handleAddImageClick4" :theme="'green'" class="text-sm">
              <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M7.0325 5.78251L8.75 4.05751V11.25C8.75 11.4489 8.82902 11.6397 8.96967 11.7803C9.11032 11.921 9.30109 12 9.5 12C9.69891 12 9.88968 11.921 10.0303 11.7803C10.171 11.6397 10.25 11.4489 10.25 11.25V4.05751L11.9675 5.78251C12.0372 5.85281 12.1202 5.90861 12.2116 5.94668C12.303 5.98476 12.401 6.00436 12.5 6.00436C12.599 6.00436 12.697 5.98476 12.7884 5.94668C12.8798 5.90861 12.9628 5.85281 13.0325 5.78251C13.1028 5.71279 13.1586 5.62984 13.1967 5.53845C13.2347 5.44705 13.2543 5.34902 13.2543 5.25001C13.2543 5.151 13.2347 5.05298 13.1967 4.96158C13.1586 4.87019 13.1028 4.78724 13.0325 4.71751L10.0325 1.71751C9.96117 1.64923 9.87706 1.59571 9.785 1.56001C9.6024 1.485 9.39759 1.485 9.215 1.56001C9.12294 1.59571 9.03883 1.64923 8.9675 1.71751L5.9675 4.71751C5.89757 4.78744 5.8421 4.87046 5.80425 4.96183C5.76641 5.05319 5.74693 5.15112 5.74693 5.25001C5.74693 5.34891 5.76641 5.44683 5.80425 5.5382C5.8421 5.62957 5.89757 5.71258 5.9675 5.78251C6.03743 5.85244 6.12045 5.90791 6.21181 5.94576C6.30318 5.9836 6.4011 6.00308 6.5 6.00308C6.59889 6.00308 6.69682 5.9836 6.78819 5.94576C6.87955 5.90791 6.96257 5.85244 7.0325 5.78251ZM16.25 9.00001C16.0511 9.00001 15.8603 9.07903 15.7197 9.21968C15.579 9.36034 15.5 9.5511 15.5 9.75001V14.25C15.5 14.4489 15.421 14.6397 15.2803 14.7803C15.1397 14.921 14.9489 15 14.75 15H4.25C4.05109 15 3.86032 14.921 3.71967 14.7803C3.57902 14.6397 3.5 14.4489 3.5 14.25V9.75001C3.5 9.5511 3.42098 9.36034 3.28033 9.21968C3.13968 9.07903 2.94891 9.00001 2.75 9.00001C2.55109 9.00001 2.36032 9.07903 2.21967 9.21968C2.07902 9.36034 2 9.5511 2 9.75001V14.25C2 14.8468 2.23705 15.419 2.65901 15.841C3.08097 16.263 3.65326 16.5 4.25 16.5H14.75C15.3467 16.5 15.919 16.263 16.341 15.841C16.7629 15.419 17 14.8468 17 14.25V9.75001C17 9.5511 16.921 9.36034 16.7803 9.21968C16.6397 9.07903 16.4489 9.00001 16.25 9.00001Z"
                    fill="white" />
          ...
          <div v-else class="house-photo-container">
            <img class="house-photo" :src="typeof localDecoration.photo4 == 'string' ? localDecoration.photo4 : photoToObjectUrl(localDecoration.photo4)" alt="">
            <div @click.stop="localDecoration.photo4 = null" class="house-photo-overlay"><img
                src='@/shared/assets/images/complexes/trash.svg' alt="Удалить"></div>
          </div>
          <template v-if="!localDecoration.photo5">
            <input @change="onImagesAdded5" accept="image/*" type="file" class="hidden" ref="editInput5" />
            <MyButton @click.stop="handleAddImageClick5" :theme="'green'" class="text-sm">
              <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M7.0325 5.78251L8.75 4.05751V11.25C8.75 11.4489 8.82902 11.6397 8.96967 11.7803C9.11032 11.921 9.30109 12 9.5 12C9.69891 12 9.88968 11.921 10.0303 11.7803C10.171 11.6397 10.25 11.4489 10.25 11.25V4.05751L11.9675 5.78251C12.0372 5.85281 12.1202 5.90861 12.2116 5.94668C12.303 5.98476 12.401 6.00436 12.5 6.00436C12.599 6.00436 12.697 5.98476 12.7884 5.94668C12.8798 5.90861 12.9628 5.85281 13.0325 5.78251C13.1028 5.71279 13.1586 5.62984 13.1967 5.53845C13.2347 5.44705 13.2543 5.34902 13.2543 5.25001C13.2543 5.151 13.2347 5.05298 13.1967 4.96158C13.1586 4.87019 13.1028 4.78724 13.0325 4.71751L10.0325 1.71751C9.96117 1.64923 9.87706 1.59571 9.785 1.56001C9.6024 1.485 9.39759 1.485 9.215 1.56001C9.12294 1.59571 9.03883 1.64923 8.9675 1.71751L5.9675 4.71751C5.89757 4.78744 5.8421 4.87046 5.80425 4.96183C5.76641 5.05319 5.74693 5.15112 5.74693 5.25001C5.74693 5.34891 5.76641 5.44683 5.80425 5.5382C5.8421 5.62957 5.89757 5.71258 5.9675 5.78251C6.03743 5.85244 6.12045 5.90791 6.21181 5.94576C6.30318 5.9836 6.4011 6.00308 6.5 6.00308C6.59889 6.00308 6.69682 5.9836 6.78819 5.94576C6.87955 5.90791 6.96257 5.85244 7.0325 5.78251ZM16.25 9.00001C16.0511 9.00001 15.8603 9.07903 15.7197 9.21968C15.579 9.36034 15.5 9.5511 15.5 9.75001V14.25C15.5 14.4489 15.421 14.6397 15.2803 14.7803C15.1397 14.921 14.9489 15 14.75 15H4.25C4.05109 15 3.86032 14.921 3.71967 14.7803C3.57902 14.6397 3.5 14.4489 3.5 14.25V9.75001C3.5 9.5511 3.42098 9.36034 3.28033 9.21968C3.13968 9.07903 2.94891 9.00001 2.75 9.00001C2.55109 9.00001 2.36032 9.07903 2.21967 9.21968C2.07902 9.36034 2 9.5511 2 9.75001V14.25C2 14.8468 2.23705 15.419 2.65901 15.841C3.08097 16.263 3.65326 16.5 4.25 16.5H14.75C15.3467 16.5 15.919 16.263 16.341 15.841C16.7629 15.419 17 14.8468 17 14.25V9.75001C17 9.5511 16.921 9.36034 16.7803 9.21968C16.6397 9.07903 16.4489 9.00001 16.25 9.00001Z"
                    fill="white" />
          ...
          <div v-else class="house-photo-container">
            <img class="house-photo" :src="typeof localDecoration.photo5 == 'string' ? localDecoration.photo5 : photoToObjectUrl(localDecoration.photo5)" alt="">
            <div @click.stop="localDecoration.photo5 = null" class="house-photo-overlay"><img
                src='@/shared/assets/images/complexes/trash.svg' alt="Удалить"></div>
          </div>
        ...
        <ConfirmPopup group="deleteDecoration" :pt="confirmpopupStyle"></ConfirmPopup>
    </div>
</template>
<script setup>
...
const emits = defineEmits(["delete-house-decoration", "save-decoration"])
const editInput = ref()
const editInput2 = ref()
const editInput3 = ref()
const editInput4 = ref()
const editInput5 = ref()
const isPreview = ref(true)
const localDecoration = ref({
    photo: null,
    photo2: null,
    photo3: null,
    photo4: null,
